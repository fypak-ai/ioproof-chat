...
// Endpoint correto: https://ioproof.com/v1/proxy/{provider}/{provider_endpoint}
...
const PROVIDER_KEY   = process.env.PROVIDER_KEY   || ''; // Sua chave OpenAI
const MODEL          = process.env.MODEL          || 'gpt-3.5-turbo';

if (!IOPROOF_KEY) {
  console.error('ERRO: IOPROOF_KEY nao definida.');
  process.exit(1);
}
